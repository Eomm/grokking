...
test('9x9 at DIFFICULT level', t => {
  ...
  t.same(solved, [9, 6, 1, 5, 8, 3, 4, 7, 2, 2, 8, 4, 1, 6, 7, 3, 5, 9, 5, 3, 7, 9, 2, 4, 8, 1, 6, 6, 2, 8, 7, 3, 5, 1, 9, 4, 7, 4, 3, 6, 9, 1, 5, 2, 8, 1, 9, 5, 2, 4, 8, 7, 6, 3, 4, 1, 9, 3, 7, 6, 2, 8, 5, 3, 7, 6, 8, 5, 2, 9, 4, 1, 8, 5, 2, 4, 1, 9, 6, 3, 7])

  const print = sudoku.printable()
  t.equal(print, '961|583|472|\n284|167|359|\n537|924|816|\n-----------|\n628|735|194|\n743|691|528|\n195|248|763|\n-----------|\n419|376|285|\n376|852|941|\n852|419|637|\n-----------|\n')
})
...
test('4x4', t => {
  ...
  t.same(solved, [3, 2, 1, 4, 1, 4, 3, 2, 4, 3, 2, 1, 2, 1, 4, 3])
